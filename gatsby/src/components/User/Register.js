...
const Register = () => {
    ...
    return (
        <>
            <h1>Register</h1>
            <button onClick={() => {tests()}}>okokok</button>
            <form method={"post"} onSubmit={e => {
                ...
                <label>
                    First name
                    <input type="text" name={"firstName"} onChange={(e) => { setFormData({ ...formData, [e.target.name]: e.target.value}) }} />
                </label>
                <label>
                    Last name
                    <input type="text" name={"lastName"} onChange={(e) => { setFormData({ ...formData, [e.target.name]: e.target.value}) }} />
                </label>
                <label>
                    Email
